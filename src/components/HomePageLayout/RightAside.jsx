  ...
  return (
    <div className={`  h-full  w-52 text-nowrap`}>
      <div className="">
        ...
        <div className="">
          ...
          <div className=" px-5">
            <div className=" flex flex-col gap-3">
              <button className=" border-cyan-400 rounded-lg border-2 p-1 hover:bg-slate-200 active:bg-slate-300">
                Google
              </button>
              <button className=" border-slate-500 rounded-lg border-2 p-1 hover:bg-slate-200 active:bg-slate-300">
                GitHub
              </button>
            </div>
          </div>
        ...
        <div className=" mt-5">
          ...
          <div className=" px-5">
            <div className=" flex flex-col border-x">
              <NavLink
                to={"/"}
                className=" px-5 flex items-center gap-3 border-y  py-5 hover:bg-slate-200 active:bg-slate-300"
              >
              ...
              <NavLink
                to={"/"}
                className=" px-5 flex items-center gap-3  py-5 hover:bg-slate-200 active:bg-slate-300"
              >
        ...
        {/* ---------- */}
        <div className=" mt-5 bg-slate-100 p-2 pb-10">
